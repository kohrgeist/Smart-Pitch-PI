  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("Meu Perfil", style: TextStyle(color: azulSmart, fontWeight: FontWeight.bold)),
        centerTitle: true,
      ),
      body: Center(
        child: Column(
          children: [
            ...
            const Text(
              "Usuário SmartPitch",
              style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: azulSmart),
            ),
            const SizedBox(height: 40),
            // Opções de Perfil
            ...
            Image.asset(
              ...
              height: 60,
              errorBuilder: (context, error, stackTrace) => const Text("SmartPitch"),
            ),
            const SizedBox(height: 40),
          ],
        ),
